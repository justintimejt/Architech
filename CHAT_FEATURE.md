# Chat Feature Documentation - Archie AI Assistant

## Overview

The Chat Feature is an AI-powered assistant called **Archie** that allows users to modify system design diagrams using natural language. Users can type commands like "Add a database node" or "Connect the API server to the database", and the AI will automatically generate and apply the necessary diagram operations.
...
```
You are Archie, an AI that helps edit a system design diagram.
